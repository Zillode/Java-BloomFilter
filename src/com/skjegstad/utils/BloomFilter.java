 ...
 *
 * If you want to avoid adding another library to your project, you may copy
 * this code directly into your project if you leave the LGPL-comment in place
 * and reference the java-bloomfilter web page:
